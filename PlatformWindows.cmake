...
add_definitions(-DANGLE_WEBKIT_WIN -DCAIRO_WIN32_STATIC_BUILD -DCURL_STATICLIB -DLIBXML_STATIC -DLIBXSLT_STATIC -DXMD_H)
...
if (${MSVC_CXX_ARCHITECTURE_ID} STREQUAL "X86")
    link_directories("${THIRDPARTY_OUTPUT_DIR}/lib32")
else ()
    link_directories("${THIRDPARTY_OUTPUT_DIR}/lib64")
endif ()
